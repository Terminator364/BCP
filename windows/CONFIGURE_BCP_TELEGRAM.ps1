...
if (Test-Path -LiteralPath $TokenPath -PathType Leaf) {
    ...
    if (-not $candidate) {
        Write-Host ("No private Telegram message observed yet. Token remains stored locally for resume. Re-run this configurator after sending /status to @" + $username + "; the token will be reused automatically.")
