...
PC_TLS_STATE_PATH = STATE_DIR / "pc_tls_identity.json"
PC_TLS_BOOTSTRAP_PATH = STATE_DIR / "BCP_TLS_PROXY_BOOTSTRAP.ps1"
PC_TLS_PORT = 8766
PC_TLS_BACKEND_PORT = 8767
...
PC_TLS_PROXY_PS1_B64 = ""


def pc_tls_binding(token: str, cert_sha256: str, port: int = PC_TLS_PORT) -> str:
    material = f"BCP-PC-TLS\\n{cert_sha256.lower()}\\n{int(port)}\\n{SERVER_VERSION}".encode("utf-8")
    return hmac.new(token.encode("utf-8"), material, hashlib.sha256).hexdigest()


def pc_tls_status(token: str = "") -> dict:
    raw = read_json(PC_TLS_STATE_PATH, {}) or {}
    fp = str(raw.get("cert_sha256") or "").lower()
    ready = bool(
        raw.get("ready") is True
        and int(raw.get("listen_port") or 0) == PC_TLS_PORT
        and int(raw.get("backend_port") or 0) == PC_TLS_BACKEND_PORT
        and re.fullmatch(r"[0-9a-f]{64}", fp)
    )
    out = {
        "ready": ready,
        "port": PC_TLS_PORT,
        "backend_port": PC_TLS_BACKEND_PORT,
        "cert_sha256": fp if ready else "",
        "protocol": "TLSv1.2_PINNED",
    }
    if ready and token:
        out["binding_hmac_sha256"] = pc_tls_binding(token, fp, PC_TLS_PORT)
    return out
...
def ensure_pc_tls_proxy(*, provision_only: bool = False) -> dict:
    ...
    current = PC_TLS_BOOTSTRAP_PATH.read_bytes() if PC_TLS_BOOTSTRAP_PATH.is_file() else b""
    if current != script_bytes:
        tmp = PC_TLS_BOOTSTRAP_PATH.with_name(PC_TLS_BOOTSTRAP_PATH.name + ".tmp")
        tmp.write_bytes(script_bytes)
        os.replace(tmp, PC_TLS_BOOTSTRAP_PATH)
    cmd = [
        "powershell.exe", "-NoProfile", "-ExecutionPolicy", "Bypass",
        "-File", str(PC_TLS_BOOTSTRAP_PATH),
        "-StateDir", str(STATE_DIR),
        "-ListenPort", str(PC_TLS_PORT),
        "-BackendPort", str(PC_TLS_BACKEND_PORT),
    ]
    if provision_only:
        cmd.append("-ProvisionOnly")
    proc = subprocess.run(
    ...
    if proc.returncode != 0:
        detail = (proc.stderr or proc.stdout or "unknown")[-500:]
        raise RuntimeError("PC_TLS_PROXY_PROVISION_FAILED:" + detail)
    status = pc_tls_status(ensure_state())
    if not status.get("ready"):
        raise RuntimeError("PC_TLS_PROXY_STATE_INVALID")
    return status
