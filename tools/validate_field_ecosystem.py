...
def main() -> int:
    ...
    assert delivery_policy["channels"]["chatgpt"]["role"] == "POINTER_ONLY_AFTER_EMAIL_HANDSHAKE"
    ...
    assert delivery_policy["checkpoint_delivery_order"] == [
        "EMAIL_START_NOTICE", "SUBSTANTIVE_WORK", "EMAIL_END_FULL_CHECKPOINT",
        "CHATGPT_POINTER_ONLY", "TELEGRAM_WITNESS_OPTIONAL"
    ]
