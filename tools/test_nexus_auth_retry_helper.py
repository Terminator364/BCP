...
def main():
    ...
    ck("normal-closeout-27-min", '"normal_closeout_offset_minutes": 27' in policy)
    ...
    ck("continuation-30-minute-cadence", '"cadence_target_minutes": 30' in registry and "targeting 30 minutes" in continuity)
    ck("communication-survival-policy", "COMMUNICATION_SURVIVAL_POLICY.json" in registry and "R73 Provider-Proof Closeout Handoff" in continuity)
