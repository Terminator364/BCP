...
def main():
    ...
    ck("normal-closeout-26-min", '"normal_closeout_offset_minutes": 26' in policy)
    ck("backup-close-28-min", '"backup_earliest_offset_minutes": 28' in policy)
    ck("hard-close-29-min", '"hard_close_guard_offset_minutes": 29' in policy)
    ck("absolute-end-30-min", '"absolute_end_deadline_minutes": 30' in policy)
