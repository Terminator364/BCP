...
def main():
    ...
    ck("communication-survival-policy", "COMMUNICATION_SURVIVAL_POLICY.json" in registry and "Communication-Survival Handoff" in continuity)
