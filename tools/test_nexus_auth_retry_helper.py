...
def main():
    ...
    ck("continuation-email-first", '"email_full_checkpoint_before_chat_pointer": true' in registry and "Email-first recovery invariant" in continuity)
    ck("continuation-8-10-cadence", '"cadence_window_minutes": [\n      8,\n      10\n    ]' in registry and "8–10 minute useful-work checkpoint cadence" in continuity)
