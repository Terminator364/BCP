...
def main():
    ...
    ck("adaptive-task-window", '"scheduling_model": "ADAPTIVE_TASK_WINDOW"' in policy and '"start_mail_includes_estimated_end_window": true' in policy)
    ...
    ck("continuation-adaptive-window", '"scheduling_model": "ADAPTIVE_TASK_WINDOW"' in registry and '"estimated_end_window_required_at_start": true' in registry and "Adaptive communication windows" in continuity)
    ck("communication-survival-policy", "COMMUNICATION_SURVIVAL_POLICY.json" in registry and "A+B+C" in continuity and "estimated end window" in continuity.lower())
    ...
    ck("communication-protocol-ref", '"schema": "bcp.communication_protocol/4"' in comm_protocol and '"scheduling_model": "ADAPTIVE_TASK_WINDOW"' in comm_protocol and '"normal_close_owner": "PRIMARY_ASSISTANT"' in comm_protocol and '"scheduled_jobs_are_normal_close_dependency": false' in comm_protocol)
    ck("communication-state-machine", '"schema": "bcp.communication_state_machine/4"' in comm_state and '"scheduling_model": "ADAPTIVE_TASK_WINDOW"' in comm_state and 'END_SEND_PENDING->END_ACKNOWLEDGED' in comm_state)
    ...
    print("R88_ADAPTIVE_DELIVERY_STATE_MACHINE_AND_NEXUS_HELPER=PASS")
    return 0
